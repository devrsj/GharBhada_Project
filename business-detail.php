                    ...
                    <div class="detail-main-info-wrap all-common-padding no-top">
                        <div class="all-common-padding u-margin-bottom-mini banner-wrap">
                            <div class="clearfix banner-top">
                                <h5 class="color-white float-left"> Business Apartment for Sale at Nayapati</h5>
                            ...
                            <div class="clearfix banner-bottom">
                                ...
                                <span class="color-white float-right">5000 Sq Feet.</span>
                            </div>
                        </div>
                    ...
                    <div class="all-common-padding">
                        <form action="booking" class="booking-form">
                            ...
                            <select name="business-type" id="business-type">
                                <option value="no-family">Nature of Business *</option>
                            ...
                            <input type="text" placeholder="Expected Number of Staffs">

                    ...
                    <div class="detail-main-info-wrap all-common-padding no-top">
                        <div class="all-common-padding u-margin-bottom-mini banner-wrap">
                            <div class="clearfix banner-top">
                                <h5 class="color-white float-left"> Hotel Lumbini</h5>
                                <span class="color-white float-right">Rent: NPR 80,000/ month</span>
                            </div>
                            <div class="clearfix banner-bottom">
                                ...
                                <span class="color-white float-right">1 Room</span>
                            </div>
                        </div>
                ...
                <div class="card1"> <!-- Card .// --->
                    ...
                    <div class="all-common-padding">
                        <form action="booking" class="booking-form">
                            ...
                            <label for="dateofbirth" class="date-label">Check In:</label>
                            <input type="date" name="dateofbirth" id="dateofbirth" class="block" required>

                            <label for="dateofbirth" class="date-label">Check Out:</label>
                            <input type="date" name="dateofbirth" id="dateofbirth" class="block" required>

                            <!-- <label for="family">Family Member</label> -->
                            <select name="people-number" id="people-number">
                                <option value="No. of Guest">No of Guests *</option>
                            ...
                            <label class="form-check">
                                ...
                                <span class="form-check-label">
                                    Attached <span class="float-right badge badge-light round">1</span>
                                </span>
                            </label>
                            ...
                            <label class="form-check">
                                <input class="form-check-input" type="radio" name="exampleRadio" value="">
                                <span class="form-check-label">
                                    Non Attached <span class="float-right badge badge-light round">4</span>
                                </span>
                            </label>

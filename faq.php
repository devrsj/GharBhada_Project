...
<section class="faq property-listing common-padding">
    <div class="container">
        <!-- <div class="text-center u-margin-bottom-small">
            <h1 class="title title-psudo">Frequently Asked Questions</h1>
        </div> -->
        ...
        <div class="row"> <!-- ROW -->
            ...
            <h2 class="title float-left">FAQs</h2>

            <div class="nav nav-tabs float-right" id="nav-tab" role="tablist">
                <a class="nav-item nav-link active" id="nav-all-tab" data-toggle="tab" href="#nav-all" role="tab" aria-controls="nav-all" aria-selected="true">Getting Started</a>
                <a class="nav-item nav-link" id="nav-appartment-tab" data-toggle="tab" href="#nav-appartment" role="tab" aria-controls="nav-appartment" aria-selected="false">Buy</a>
                <a class="nav-item nav-link" id="nav-office-tab" data-toggle="tab" href="#nav-office" role="tab" aria-controls="nav-office" aria-selected="false">Sell</a>
            </div>
        </nav>

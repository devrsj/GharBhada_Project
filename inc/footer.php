<footer class="footer">
      ...
      <div class="row">
        <div class="col-lg-4 col-sm-6 col-xs-12 resp-marg">
          ...
          <ul class="footer-list">
            ...
            <!-- <li class="footer-item"><a href="#" class="footer-link">Rent your Property</a></li> -->
            <!-- <li class="footer-item"><a href="#" class="footer-link">Latest Properties</a></li> -->
            <!-- <li class="footer-item"><a href="#" class="footer-link">How we Work?</a></li> -->
            <li class="footer-item"><a href="about.php" class="footer-link">About us</a></li>
            <li class="footer-item"><a href="blog.php" class="footer-link">Blog</a></li>
            <li class="footer-item"><a href="contact.php" class="footer-link">Contact Us</a></li>

            <li class="footer-item"><a href="faq.php" class="footer-link">FAQs</a></li>
            <li class="footer-item"><a href="privacy.php" class="footer-link">Privacy Policy</a></li>
  ...
  <div class="footer-copyright clearfix"> <!-- Footer-copyright -->
    <div class="container">
      <p class="float-left">Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved <a href="#" target="_blank">Rental Company</a></p>
      <p class="float-right">Designed & Developed by <a href="https://orbitechnepal.com/" target="_blank">Orbitech</a></p>
    </div>

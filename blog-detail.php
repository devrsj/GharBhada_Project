...
<section class="bread-crumb bg-bread">
    <div class="container">
        <h3 class="bread-crumb-title text-center">Blog Detail Page</h3>
...
<section class="blog-detail-main common-padding bg-grey">
    <div class="container">
            <div class="row"> <!-- Row -->
                    ...
                    <div class="blog-box"> <!-- BLOG-BOX -->
                        ...
                        <div class="blog-post-detail clearfix mb-4">
                            ...
                            <ul class="blog-detail blog-stats float-left">
                                ...
                                <li class="blog-stats-item"><span><i class="fas fa-heart"></i> 6</span></li>
                                <li class="blog-stats-item"><span><i class="far fa-comment"></i> 2</span></li>
                                <li class="blog-stats-item"><span><i class="fas fa-star"></i> 5</span></li>
                            </ul>
                        </div>
                        ...
                        <p class="blog-description">Nulla dignissim non augue at placerat. Integer vel ipsum at massa finibus finibus interd um vel eros. Aliquam sollicitudin leo eget erat tempor pellentesque. Etiam faucibus odio vel libero imperdiet, vitae dignissim dui suscipit. Nullam luctus... Lorem, ipsum dolor sit amet consectetur adipisicing elit. Doloremque, eos explicabo. Dolorem, ducimus. Assumenda expedita fugiat tempore unde ipsam vel ad reiciendis, placeat cumque iure. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Exercitationem mollitia a eos temporibus odit autem! Quasi nemo sunt debitis earum veritatis optio iste suscipit! Maxime illum blanditiis, accusamus soluta vel iste. Molestias placeat vero iste.</p>

                    </div> <!-- BLOG-BOX -->

                    <div class="blogdetail-author-info u-margin-bottom-mini"> <!-- DETAIL-BOX -->
                        <div class="d-flex resp-block">
                            <div class="blogdetail-author-img-wrap">
                                <img src="images/author.jpg" alt="">
                            </div>

                            <div class="blogdetail-author-content-wrap">
                                <p class="author-about">About Author</p>
                                <p class="about-post color-secondary">Admin</p>
                                <p class="blog-author-desc">Fusce eget dapibus neque. Nam imperdiet libero eu risus imperdiet, tempor ultrices mi interdum. Nunc augue enim, mattis quis pharetra a, interdum a ex.</p>
                            </div>
                        </div>
                    </div> <!-- DETAIL-BOX -->

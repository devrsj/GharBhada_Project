...
<section class="bread-crumb bg-bread">
	<div class="container">
		<h3 class="bread-crumb-title text-center">Business Listing</h3>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-lg-3">
				...
				<div class="card u-margin-bottom-mini">
					<article class="card-group-item">
						...
						<div class="filter-price card-body no-top">
							<!-- Card Body -->
			...
			<div class="card">
				...
				<article class="card-group-item">
					<header class="card-header">
						<h6 class="title">Special Offer on: </h6>
					</header>
					<div class="filter-content">
						<!---------------------------------------->
						<!---------------Side-Special-Offer---------------->
		...
		<div class="col-lg-9">
				...
				<div class="col-lg-4 col-sm-6 col-xs-12">
					...
					<div class="card1 card2">
						...
						<div class="card1-detail">
							<h5 class="card1-title"><a href="business-detail.php">Fully furnished Apparment</a></h5>
			...
			<div class="news-pagination u-margin-top-mini">
				<!-- // Pagination--->
